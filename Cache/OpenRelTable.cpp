...
//   // load the relation and attribute catalog into the relation cache (we did
//   // this already)
...
//   // load the relation and attribute catalog into the attribute cache (we did
//   // this already)
...
//         ATTRCAT_RELID, RELCAT_ATTR_RELNAME, attrVal, EQ);
